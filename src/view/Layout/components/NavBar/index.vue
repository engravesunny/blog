<template>
  <div
    class="navbar_container unselectable"
    :style="{
    ...
    <div class="controls">
      ...
      <template v-if="!showHam">
        ...
        >
          ...
          <downSelect
            v-if="alive.name === item.name"
            :chirlden="item.children"
          ></downSelect>
        </div>
      </template>
      ...
      <div
        class="mark"
        @click="openMenu"
        :style="{ background: `rgba(0,0,0,${mark})`, width: `${markw}vw` }"
      ></div>
      <div
        class="menu_side"
        :style="{ transform: `translate(-${isOpenMenu}px)` }"
      >
