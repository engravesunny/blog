            ...
            <div class="layout">
                <div class="page">
                    <div class="github" v-loading="loadingGithub">
                        <github v-if="!loadingGithub" :data-info="commitInfo" :color="colorData" :data="githubData">
                        </github>
                    </div>
                    <div class="tarffic">
                        <traffic></traffic>
...
const computedCommit = (data) => {
    ...
    const lastYearDay = data.weeks[52].contributionDays[data.weeks[52].contributionDays
        .length - 1].date
    ...
    weekCount += secondLastWeek.contributionDays.reduceRight((weekCount, item) => {
        if (tempWeekCount === weekDaysCount - 1) {
            tempWeekCount++;
            firstWeekDay = item.date
            return weekCount
